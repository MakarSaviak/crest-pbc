module crest_parameters
  ...
  real(wp),parameter,private :: fine_structure_constant = 7.2973525693e-3_wp
  real(wp),parameter,public :: jtoau = 1.0_wp/(metokg*c_vacuum**2*fine_structure_constant**2)
  real(wp),parameter,public :: vatoau = jtoau/(ctoau*aatoau)
