...
def test_gfn1_xtb_3d():
    ...
    forces = np.array(
        [
            [+0.01319623, +0.03071894, +0.02614915],
            [-0.09544978, +0.06115141, -0.05337731],
            [-0.05110148, -0.09890319, +0.05463402],
            [+0.05693538, -0.04866581, -0.09186471],
            [-1.91869841, -1.91785107, -1.92192620],
            [+2.00015886, +1.98162414, +1.99120287],
            [-1.94352841, -1.94268893, +1.93401276],
            [+1.94156111, +1.97582375, -1.97215899],
            [-1.97037962, +1.94359293, +1.98489943],
            [+1.93023982, -1.94062896, -1.94627673],
            [+1.97602564, -1.98029483, +1.93551714],
            [-1.93895933, +1.93612163, -1.94081143],
        ]
    )
    stress = np.array(
        [
    ...
    assert approx(atoms.get_potential_energy(), abs=thr) == -1256.828281193051
    assert approx(atoms.get_forces(), abs=thr) == forces
